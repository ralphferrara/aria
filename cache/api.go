...
//||------------------------------------------------------------------------------------------------||
//|| Redis/KeyDB: Delete Key
//||------------------------------------------------------------------------------------------------||

func (c *RedisCacheWrapper) Del(key string) error {
...
func (c *MemcachedCacheWrapper) Del(key string) error {
...
func (c *MemoryCacheWrapper) Del(key string) {
	delete(c.Store, key)
}
